...
| Static viewers | Replay / Pareto / attribution UIs over HTTP | **`composite_viewer/`** for quad composite v3; network chain path preset in attribution viewer; still no server-side simulation |
