...
| `scripts/fragility_robustness_sweep.py` | Moonshot: ensemble over **`graph_seed`**; optional **`--sweep-param`** + **`--sweep-values`** for 1D sensitivity (`fragility-robustness-sensitivity-1d-v1`) |
