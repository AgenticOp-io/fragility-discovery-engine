...
**Backlog (not gates yet):** formal Shapley-style decompositions; richer Phase J counterfactual vocabulary beyond remove-steps / initial-overload shift (resource cascade joint merge CLI is shipped).
