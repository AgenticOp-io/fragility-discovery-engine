...
- [x] **Research flight 1** — QD `scenario-archive-v1`, differential stress, PROV-lite `evidence-pack-v1` ([`docs/RESEARCH_EXTENSIONS.md`](RESEARCH_EXTENSIONS.md)).
- [x] **Research flight 2** — plausibility axis (`plausibility-search-v1`) + discrete STL subset (`stl-robustness-v1`).
- [ ] **engrXiv** — paste kit ready: [`docs/preprint/ENGRxIV_SUBMISSION.md`](preprint/ENGRxIV_SUBMISSION.md); submit at https://engrxiv.org/about/submissions
- [ ] **arXiv** — blocked on endorsement ([`docs/preprint/ARXIV_ENDORSEMENT.md`](preprint/ARXIV_ENDORSEMENT.md)).
