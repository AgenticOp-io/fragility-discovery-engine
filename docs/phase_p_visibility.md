...
| Host | URL |
|------|-----|
| **GCE** (`chrysalis-test-vm`, nginx) | FDE: https://fragility.agenticop.io/ · IP fallback: http://34.61.255.147/ · Hub: https://hub.agenticop.io/ · Hub direct: http://34.61.255.147:19090/ |
