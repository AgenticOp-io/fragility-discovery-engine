...
Checks DNS for an optional FDE hostname, deploy key, optional `PYPI_API_TOKEN`, and http://34.61.255.147/status.json. Note: `hub.agenticop.io` is Translation Hub on this VM, not the FDE site.
